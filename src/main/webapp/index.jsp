...
<html>
    ...
    <body>
        ...
        <div class="left" style="background-color:#aaa;">
                        ...
                        <input class="table" type="submit" value="Carport med Hældning">
        ...
        <div class="middle" style="background-color:#bbb;">
                        ...
                        <input class="table" type="submit" value="Carport uden Hældning">
        ...
        <div class="right" style="background-color:#ccc;">
                        ...
                        <input class="table" type="submit" value="Carport efter egen mål">
                </form> </div>
        <div class="footer">
